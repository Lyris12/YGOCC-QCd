...
function s.initial_effect(c)
	--U-If this card is Engaged while you control "The City of Belgrade": You can increase its Energy by 2. ▼ [-4]: If your opponent activates a Trap card or effect that would target or destroy a "Kronologistics" monster you control: Negate the activation. ▼ [-4]: Set 1 Trap card that specifically lists "Kronologistics Tune Duelist", "Kronologistic Fault Hunter", or "The Spirit of Belgrade" in its text directly from your Deck.
