...
function c19822112.initial_effect(c)
	c:EnableReviveLimit()
	--mat=3 "Shadow NOVA" monsters
	aux.AddLinkProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xe1f),3,3)
	--The effects of "Shadow NOVA" monsters this card points to cannot be negated, except by Spell cards and effects, and this card.
	...
	c:RegisterEffect(e5)
	--You can only use each effect of "Shadow NOVA Dragon" once per turn.
	--During your Main Phase: You can add 1 "Shadow NOVA" monster from your Deck to your hand.
	...
	c:RegisterEffect(e1)
	--If a monster(s) this card points to is destroyed by an opponent's card effect (except during the Damage Step): You can send 1 "Shadow NOVA" monster from your hand to the GY; Special Summon those destroyed monsters to your zone(s) this card points to, ignoring their Summoning conditions, but their effects are negated until your next Standby Phase.
