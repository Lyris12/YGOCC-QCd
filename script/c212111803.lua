...
function s.initial_effect(c)
	--U-If this card is Engaged while you control "The City of Belgrade": You can roll a six-sided die, then gain Energy equal to the result. [0]: Roll a six-sided die, then gain or lose Energy equal to the result. ▼ [-18]: Roll six-sided dice, equal to the number of cards your opponent controls, then destroy 1 card your opponent controls for every die that rolled a 4, 5, or 6. ★ [OD]: Add 1 "The City of Belgrade" from your Deck to your hand.
