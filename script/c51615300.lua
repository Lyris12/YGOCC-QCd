--Epochborn Swordsman
function c51615300.initial_effect(c)
	--You can only use each effect of "Epochborn Swordsman" once per turn.
	--If this card is Normal or Special Summoned: You can add 1 "Epochborn" monster from your Deck to your hand.
	...
	c:RegisterEffect(e3)
	--If this card is banished or sent to the GY, except as Link Material; You can Special Summon 1 "Epochborn" monster from your hand.
	...
	c:RegisterEffect(e4)
	--If this card is used as Time Leap Material for the Time Leap Summon of an "Epochborn" monster: You can target 1 monster your opponent controls; Destroy it.
